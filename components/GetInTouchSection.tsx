...
export default function GetInTouchSection() {
  ...
  return (
    <section
      ...
      className="relative flex min-h-screen w-full items-center justify-center bg-secondary"
    >
      <div
      ...
      >
        ...
        <div aria-hidden="true" className="shrink-0">
          <div className="relative aspect-square w-64 overflow-hidden rounded-xl border-2 border-border bg-card shadow-md md:w-80">
            <Image
        ...
        <div className="w-full shrink-0 md:max-w-md">
          <div className="rounded-xl border border-white bg-white/60 p-8 shadow-lg backdrop-blur-xl dark:border-white/10 dark:bg-white/5 md:p-10">
            <h2
